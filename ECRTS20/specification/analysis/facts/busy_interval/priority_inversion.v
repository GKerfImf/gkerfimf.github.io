...
Section PriorityInversionIsBounded.
  ...
  Section PreemptionTimeExists.
    ...
    (** Thus, there must be a preemption time in the interval 
        <<[t1, t1 + max_priority_inversion t1]>>. That is, if a job with
    ...
    (** By doing the case analysis, we show that indeed there is a
        preemption time in time interval 
        <<[t1, t1 + max_length_of_priority_inversion j t1]>>. *)
