...
Section Composition.
  ...
  (** Next, we observe that we can look at the service received during
     an interval <<[t1, t3)>> as the sum of the service
     during <<[t1,t2)>> and <<[t2, t3)>> for any [t2 \in [t1, t3]]. (The "cat"
     suffix denotes the concatenation of the two intervals.) *)
  ...
  (** Finally, we deconstruct the service received during an interval
     <<[t1, t3)>> into the service at a midpoint [t2] and the service
     in the intervals before and after. *)
